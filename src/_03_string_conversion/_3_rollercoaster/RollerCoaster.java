...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		public static void main(String[] args) {
			...
			if( heightAsInt >= 48 ) {JOptionPane.showMessageDialog(null, "Hurray! You are tall enough to ride the coaster alone!"); }
			else if (heightAsInt >= 42) {JOptionPane.showMessageDialog(null, "You can ride the coaster with someone else!" ); }
			else {

				JOptionPane.showMessageDialog(null,  "must be at least 42 inches tall to ride the roller coaster pal!");
			}
			}
			}
